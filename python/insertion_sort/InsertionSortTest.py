...
print(insertion_sort(dados_ordenados))
print(insertion_sort(dados_inversamente_ordenados))
print(insertion_sort(dados_inversamente_ordenados_2))
print(insertion_sort(dados_inversamente_ordenados_3))
print(insertion_sort(dados_aleatorios))
print(insertion_sort(dados_aleatorios_2))
print(insertion_sort(dados_aleatorios_3))
print(insertion_sort(dados_repetidos))
